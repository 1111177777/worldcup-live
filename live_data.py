...
<div class="guide">
<div class="guide-t" onclick="this.classList.toggle('open');this.nextElementSibling.classList.toggle('open')">📖 使用说明（点我展开）</div>
<div class="guide-b">
<b>🔍 搜索：</b>顶部输入框搜球队名，快速定位比赛<br>
<b>📊 概率怎么看：</b>胜/平/负是统计模型推演的参考概率，非真实赔率，仅供参考<br>
<b>⭐ 星级：</b>价值评分，最高5星，基于概率与市场差异计算<br>
<b>🏷️ 标签：</b>伤病/风险/价值标签，提示关注点<br>
<b>📈 比分分布：</b>TOP5 最可能出现的比分及其概率<br>
<b>🔄 自动刷新：</b>页面每60秒自动刷新获取最新数据<br>
<b>🟢 在线人数：</b>当前正在查看页面的用户数量<br>
<b>⚠️ 免责：</b>所有数据为数学模型统计结果，仅供赛事数据研究参考
</div>
</div>
{dashboard_html}
