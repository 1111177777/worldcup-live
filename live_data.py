...
STYLE = {
    ...
    "日本":(1.25,1.05),"加拿大":(1.0,0.85),"澳大利亚":(0.9,0.95),
...
# 近期状态修正（基于6月热身赛+最近正式比赛）：正值=状态好，负值=状态差
FORM_BOOST = {
    "德国": 100,   # 9连胜
    "日本": 80,    # 5连胜5零封+赢巴西英格兰
    "比利时": 60,  # 5-0突尼斯+2-0克罗地亚
    "巴西": 50,    # 两场热身全胜
    "阿根廷": 50,  # 3-0冰岛+2-0洪都拉斯
    "英格兰": 50,  # 3-0哥斯达黎加+1-0新西兰
    "墨西哥": 50,  # 5-1塞尔维亚+揭幕战2-0南非
    "韩国": 40,    # 5-0特立尼达+1-0萨尔瓦多+揭幕战逆转
    "葡萄牙": 40,  # 2-1尼日利亚+2-1智利
    "阿尔及利亚": 40, # 4-0玻利维亚
    "苏格兰": 30,  # 4-0玻利维亚
    "西班牙": 30,  # 3-1秘鲁
    "摩洛哥": 30,  # 4-0马达加斯加
    "哥伦比亚": 30,# 3-1哥斯达黎加+2-0约旦
    "土耳其": 30,  # 4-0北马其顿+2-1委内瑞拉
    "挪威": 30,    # 3-1瑞典
    "厄瓜多尔": 30,# 3-0危地马拉
    "奥地利": 20,  # 1-0突尼斯
    "捷克": 10,    # 热身3-1危地马拉，但揭幕战1-2输韩
    "加拿大": 10,  # 2-0乌兹别克斯坦
    "法国": 10,    # 3-1北爱尔兰但1-2科特迪瓦
    "巴拉圭": 10,  # 4-0尼加拉瓜
    "海地": 10,    # 4-0新西兰+2-1秘鲁
    "库拉索": 10,  # 4-0阿鲁巴
    "美国": -20,   # 1-2德国
    "荷兰": -30,   # 0-1阿尔及利亚+2-1乌兹别克
    "克罗地亚": -10,# 0-2比利时
    "南非": -20,   # 揭幕战0-2输
}
